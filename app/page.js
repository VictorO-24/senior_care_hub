  ...
  return (
    <Container maxWidth="100vw" sx={{ bgcolor: "#e0e0e0" }}>
      ...
      <Box sx={{ textAlign: "center", my: 4 }}>
        <Typography variant="h2" gutterBottom sx={{ color: "#004d40" }}>
        ...
        <Button
          variant="contained"
          sx={{ mt: 2, bgcolor: "#004d40", color: "#fff" }}
      ...
      <Box sx={{ my: 6 }}>
        <Typography variant="h4" component="h2" gutterBottom textAlign="center" sx={{ color: "#004d40" }}>
          Our Services
        </Typography>
        <Box sx={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
          <Box sx={{ 
            ...
            <Typography>Personalized care services in the comfort of your own home.</Typography>
            <Button
              variant="contained"
              sx={{ mt: 2, bgcolor: "#388e3c", color: "#fff" }}
              onClick={handleViewServices}
            >
              Learn More
            </Button>
          ...
          <Box sx={{ 
            ...
            <Typography>Comprehensive medical services tailored for seniors.</Typography>
            <Button
              variant="contained"
